...
(function () {
  ...
  module.controller("GnCatController", [
    ...
    function (
      ...
      $scope.isDarkMode = localStorage.getItem("gn-dark-mode") === "true";

      // Apply dark mode class if it was previously enabled
      if ($scope.isDarkMode) {
        angular.element(document.body).addClass("gn-dark-theme");
      }

      // Toggle between light and dark mode
      $scope.toggleDarkMode = function () {
        $scope.isDarkMode = !$scope.isDarkMode;
        localStorage.setItem("gn-dark-mode", $scope.isDarkMode);

        if ($scope.isDarkMode) {
          angular.element(document.body).addClass("gn-dark-theme");
        } else {
          angular.element(document.body).removeClass("gn-dark-theme");
        }
      };
